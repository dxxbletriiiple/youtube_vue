						...
						<ul>
							<li>
								<a href="#" class="flex items-center px-3 py-2 text-sm hover:bg-gray-100">
									<svg class="w-6 h-6 mr-3 text-red-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
										<path
											fill-rule="evenodd"
						...
						<ul>
							<li>
								<a href="#" class="flex items-center px-4 py-2 text-sm hover:bg-gray-100">
									<svg class="w-6 h-6 mr-3 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
										<path
											fill-rule="evenodd"
									...
									<svg class="w-5 h-5 text-gray-400 ml-auto" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
										<path
											fill-rule="evenodd"
